...
# train
#python main.py -device -1 -batch_size 32 -model RNN_RNN -seed 1 -save_dir checkpoints/XXX.pt
...
print("heelo", torch.cuda.is_available())
...
def test():
    ...
    #net.load_state_dict(torch.load(checkpoint['model'], map_location='cpu'))
